...
#include "VirtualGeometry/Streaming/CLodPageLRU.h"
...
#include "VirtualShadows/StreamingIntegration/VirtualShadowUpgradeService.h"
...
private:
    ...
    void RecordStreamingCompletion(uint32_t groupIndex, const br::render::CLodDiskStreamingCompletion& completion);
    ...
    PreAllocatedPages PreAllocatePagesForGroup(uint32_t groupIndex, const br::render::CLodGroupStreamingInfo& info, ICLodGeometryStorage* meshManager);
    ...
    std::unordered_map<uint32_t, br::render::CLodDiskStreamingCompletion> m_readyStreamingCompletionsByGroup;
    ...
    std::vector<br::render::CLodStreamingDomainEvent> m_streamingDomainEventScratch;
