...
#include "VirtualGeometry/Culling/PreparedCullingWorkloads.h"
...
public:
    HierarchicalDispatchCullingPass(
        ...
        std::shared_ptr<org::Buffer> shadowInvalidationCountBuffer = nullptr,
        ...
        std::shared_ptr<org::Buffer> shadowReceiverSubpageMaskBuffer = nullptr,
...
private:
    using EmissionBuffer = std::shared_ptr<org::Buffer>;
    template<class EmissionData, class CommandSink>
    static org::PassReturn EmitCommands(const EmissionData& inputs, CommandSink& commandList,
    ...
    org::PipelineState m_pureComputeBuildDispatchArgsPipelineState;
    org::PipelineState m_pureComputeBuildDualDispatchArgsPipelineState;
    org::PipelineState m_pureComputeClearTraversalCountersPipelineState;
    org::PipelineState m_pureComputeBuildReplayDispatchArgsPipelineState;
    org::PipelineState m_pureComputeObjectCullPipelineState;
    org::PipelineState m_pureComputeReplayNodesPipelineState;
    org::PipelineState m_pureComputeReplayClustersPipelineState;
    org::PipelineState m_pureComputeTraversePipelineState;
    org::PipelineState m_pureComputeLeafPipelineState;
    org::PipelineState m_pureComputeClusterPipelineState;
    org::PipelineState m_pureComputeDenseClusterPipelineState;
    ...
    std::shared_ptr<org::Buffer> m_phase1VisibleClustersCounterBuffer;
    std::shared_ptr<org::Buffer> m_swWriteBaseCounterBuffer;
    ...
    std::shared_ptr<org::Buffer> m_dynamicWindBoundsCacheBuffer;
    org::Resource* m_dynamicWindVisibleMembershipBuffer = nullptr;
    uint32_t m_dynamicWindBoundsCacheEntryCount = 0u;
    uint32_t m_dynamicWindBoundsCacheGeneration = 1u;
    std::shared_ptr<org::Buffer> m_pureComputeCurrentNodeFrontierBuffer;
    std::shared_ptr<org::Buffer> m_pureComputeNextNodeFrontierBuffer;
    std::shared_ptr<org::Buffer> m_pureComputeCurrentLeafFrontierBuffer;
    std::shared_ptr<org::Buffer> m_pureComputeNextLeafFrontierBuffer;
    std::shared_ptr<org::Buffer> m_pureComputeClusterFrontierBuffer;
    std::shared_ptr<org::Buffer> m_pureComputeCurrentNodeCounterBuffer;
    std::shared_ptr<org::Buffer> m_pureComputeNextNodeCounterBuffer;
    std::shared_ptr<org::Buffer> m_pureComputeCurrentLeafCounterBuffer;
    std::shared_ptr<org::Buffer> m_pureComputeNextLeafCounterBuffer;
    std::shared_ptr<org::Buffer> m_pureComputeClusterCounterBuffer;
    std::shared_ptr<org::Buffer> m_pureComputeNodeDispatchArgsBuffer;
    std::shared_ptr<org::Buffer> m_pureComputeLeafDispatchArgsBuffer;
    std::shared_ptr<org::Buffer> m_pureComputeClusterDispatchArgsBuffer;
