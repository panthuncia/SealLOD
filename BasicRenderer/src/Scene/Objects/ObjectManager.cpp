...
void ResetPreparedStaticGroupsPlanForReuse(br::render::PreparedStaticGroupsBulkPlan& plan)
{
...
void ResetStaticImportBuildBatchForReuse(br::render::StaticImportBuildBatch& build)
{
...
br::render::StaticImportBuildBatch AcquireStaticImportBuildScratch()
{
	return {};
}

void RetireStaticImportBuildScratch(br::render::StaticImportBuildBatch& build) {
...
std::vector<DrawWorkloadKey> ResolveStaticTemplateWorkloadKeys(const br::render::StaticMeshTemplateRef& meshTemplate)
{
...
std::vector<DrawWorkloadKey> ResolveStaticTemplateWorkloadKeys(const br::render::PreparedStaticMeshTemplateRef& meshTemplate)
{
	const auto keys = meshTemplate.WorkloadKeys();
	return { keys.begin(), keys.end() };
}

void BuildPreparedStaticGroupWorkloadRoutes(br::render::PreparedStaticGroupInfo& group)
{
...
void PrepareStaticGroupsBulkPlanInPlace(
	br::render::PreparedStaticGroupsBulkPlan& plan,
	const std::vector<br::render::StaticGroupBuildInfo>& groups)
{
...
void ForEachActiveDrawSetRemoval(
	const br::render::StaticObjectRemovalPayload& payload,
	Fn&& fn)
{
...
void ObjectManager::SetDesiredBufferStateReadyCallback(
	br::render::DesiredBufferStateReadyCallback callback) {
...
br::render::DesiredObjectBufferStateCut ObjectManager::DesiredBufferStateCut() const {
	std::lock_guard graphStateLock(m_objectBufferGraphStateMutex);
...
void ObjectManager::AcknowledgePublishedBufferState(
	...
	br::render::DesiredBufferStateReadyCallback readyCallback;
	{
		std::lock_guard lock(m_desiredBufferStateReadyCallbackMutex);
...
std::vector<br::render::ActiveDrawSetCompactionPublishResult> ObjectManager::PublishActiveDrawSetCompactionResults(std::size_t maxResults) {
	std::lock_guard mutationLock(m_staticPublicationMutationMutex);
	std::vector<br::render::ActiveDrawSetCompactionPublishResult> published;
	...
	for (auto& result : results) {
		...
		published.push_back(br::render::ActiveDrawSetCompactionPublishResult{
...
std::vector<br::render::ActiveDrawSetDebugStats> ObjectManager::SnapshotActiveDrawSetDebugStats() const {
	std::vector<br::render::ActiveDrawSetDebugStats> stats;
	...
	for (const auto& [workloadKey, buffer] : m_activeDrawSetIndices) {
		...
		br::render::ActiveDrawSetDebugStats row{};
...
br::render::ObjectStorageStats ObjectManager::GetStats() const {
	auto stats = m_stats;
...
void ObjectManager::AssignStaticImportTransactionGenerations(br::render::MaterializedStaticImportTransaction& transaction) {
	br::render::MaterializedStaticImportTransaction* transactions[] = { &transaction };
	AssignStaticImportTransactionGenerations(std::span<br::render::MaterializedStaticImportTransaction*>(transactions));
}

void ObjectManager::AssignStaticImportTransactionGenerations(std::span<br::render::MaterializedStaticImportTransaction*> transactions) {
...
Components::ObjectDrawInfo ObjectManager::AddObject(const PerObjectCB& perObjectCB, const Components::MeshInstances* meshInstances) {
	std::vector<br::render::ObjectBuildInfo> objects;
...
std::vector<Components::ObjectDrawInfo> ObjectManager::AddObjectsBulk(const std::vector<br::render::ObjectBuildInfo>& objects) {
...
br::render::PreparedStaticGroupsBulkPlan ObjectManager::PrepareStaticGroupsBulkPlan(const std::vector<br::render::StaticGroupBuildInfo>& groups) {
	br::render::PreparedStaticGroupsBulkPlan plan;
	PrepareStaticGroupsBulkPlanInPlace(plan, groups);
	return plan;
}

void ObjectManager::PrepareStaticGroupCommitResourcesAsync(const br::render::PreparedStaticGroupsBulkPlan& plan) {
...
br::render::StaticImportPacketPlan ObjectManager::PrepareStaticImportPacketPlan(const std::vector<br::render::StaticGroupBuildInfo>& groups) {
	br::render::StaticImportPacketPlan plan;
	plan.prepared = PrepareStaticGroupsBulkPlan(groups);
	return plan;
}

void ObjectManager::RequestStaticImportPacketResources(const br::render::StaticImportPacketPlan& plan) {
	ZoneScopedN("ObjectManager::RequestStaticImportPacketResources");
	PrepareStaticGroupCommitResourcesAsync(plan.prepared);
}

br::render::StaticImportBuildBatch ObjectManager::PrepareStaticImportBuildBatch(const std::vector<br::render::StaticGroupBuildInfo>& groups) {
	br::render::StaticImportBuildBatch build = AcquireStaticImportBuildScratch();
	PrepareStaticGroupsBulkPlanInPlace(build.prepared, groups);
	FinalizeStaticImportBuildBatch(build);
	return build;
}

void ObjectManager::FinalizeStaticImportBuildBatch(br::render::StaticImportBuildBatch& build) {
...
br::render::StaticImportBuildBatch ObjectManager::FinalizeStaticRecipeBuild(br::render::StaticRecipeView view) {
...
void ObjectManager::RequestStaticImportTransactionResources(const br::render::StaticImportBuildBatch& build) {
	ZoneScopedN("ObjectManager::RequestStaticImportTransactionResources");
	PrepareStaticGroupCommitResourcesAsync(build.prepared);
}

br::render::StaticImportResourceProbe ObjectManager::CreateStaticImportResourceProbe() const {
...
br::render::StaticImportResourceProbeStatus ObjectManager::ProbeStaticImportTransactionResources(
	br::render::StaticImportBuildBatch& build,
	br::render::StaticImportResourceProbe& probe)
{
	ZoneScopedN("ObjectManager::ProbeStaticImportTransactionResources");
	{
		...
		if (build.prepared.groups.empty()) {
			return br::render::StaticImportResourceProbeStatus::Empty;
		}
	}
	...
	return br::render::StaticImportResourceProbeStatus::Ready;
}

br::render::StaticImportReservationStatus ObjectManager::TryReserveStaticImportTransaction(
	br::render::StaticImportBuildBatch build,
	br::render::StaticImportReservation& reservation)
{
	...
	return statuses.empty() ? br::render::StaticImportReservationStatus::Empty : statuses.front();
}

std::vector<br::render::StaticImportReservationStatus> ObjectManager::TryReserveStaticImportTransactionsBatch(
	std::vector<br::render::StaticImportBuildBatch>& builds,
	std::vector<br::render::StaticImportReservation>& reservations)
{
	ZoneScopedN("ObjectManager::TryReserveStaticImportTransactionsBatch");
	std::vector<br::render::StaticImportBuildBatch*> buildPtrs;
	...
	for (std::size_t i = 0; i < builds.size() && i < reservations.size() && i < statuses.size(); ++i) {
		if (statuses[i] == br::render::StaticImportReservationStatus::Ready) {
...
std::vector<br::render::StaticImportReservationStatus> ObjectManager::TryReserveStaticImportTransactionsInPlace(
	std::span<br::render::StaticImportBuildBatch*> builds,
	std::vector<br::render::StaticImportReservation>& reservations)
{
	ZoneScopedN("ObjectManager::TryReserveStaticImportTransactionsInPlace");
	std::vector<br::render::StaticImportReservationStatus> statuses(builds.size(), br::render::StaticImportReservationStatus::Empty);
	reservations.clear();
	...
	for (std::size_t buildIndex = 0; buildIndex < builds.size(); ++buildIndex) {
		...
		reservation = {};
		if (!buildPtr) {
			statuses[buildIndex] = br::render::StaticImportReservationStatus::Empty;
			continue;
		}
		auto& build = *buildPtr;
		if (build.prepared.groups.empty()) {
		...
		if (!m_normalMatrixBuffer->TryAllocateRangesBatch(
			...
			statuses[buildIndex] = br::render::StaticImportReservationStatus::PendingResources;
			++pendingCount;
			continue;
		}
		...
		statuses[buildIndex] = br::render::StaticImportReservationStatus::Ready;
		++readyCount;
...
br::render::MaterializedStaticImportTransaction ObjectManager::MaterializeStaticImportTransaction(br::render::StaticImportReservation reservation) const {
	return MaterializeStaticImportTransaction(std::move(reservation), reservation.build);
}

br::render::MaterializedStaticImportTransaction ObjectManager::MaterializeStaticImportTransaction(
	br::render::StaticImportReservation&& reservation,
	br::render::StaticImportBuildBatch& buildScratch) const
{
	...
	const auto legacyDrawInfoCount = static_cast<std::size_t>(std::ranges::count_if(
		...
		[](const br::render::PreparedStaticGroupInfo& group) { return !group.IsRecipeView(); }));
	...
	transaction.activeDrawSetRemovalStorage =
		std::make_shared<br::render::StaticObjectRemovalPayload::ActiveDrawSetRemovalStorage>();
	...
	for (std::size_t groupIndex = 0; groupIndex < groupCount; ++groupIndex) {
		...
		if (drawInfo) {
			...
			const auto addRecipeRange = [&removalPayload](
				...
				br::render::StaticObjectRemovalPayload::BufferKind kind) {
			...
			addRecipeRange(m_perObjectBuffers, perObjectRange, br::render::StaticObjectRemovalPayload::BufferKind::PerObject);
			addRecipeRange(m_perInstanceTransformBuffers, instanceTransformRange, br::render::StaticObjectRemovalPayload::BufferKind::InstanceTransform);
			addRecipeRange(m_normalMatrixBuffer, normalRange, br::render::StaticObjectRemovalPayload::BufferKind::NormalMatrix);
			addRecipeRange(m_instanceDrawRecordBuffers, drawRecordRange, br::render::StaticObjectRemovalPayload::BufferKind::InstanceDrawRecord);
		...
		for (const auto& type : skinnedTypes) {
			for (std::uint32_t transformIndex = 0; transformIndex < transformCount; ++transformIndex) {
				br::render::MaterializedStaticImportTransaction::PendingSkinnedAssemblyPlacement pending{};
...
void ObjectManager::PublishSkinnedAssemblyPlacements(br::render::MaterializedStaticImportTransaction& transaction) {
...
br::render::StaticImportPublishResult ObjectManager::PublishStaticImportTransaction(br::render::MaterializedStaticImportTransaction transaction) {
	...
	br::render::StaticImportPublishResult result;
...
br::render::StaticImportBulkPublishResult ObjectManager::PublishStaticImportTransactionsBulk(std::span<br::render::MaterializedStaticImportTransaction*> transactions) {
	ZoneScopedN("ObjectManager::PublishStaticImportTransactionsBulk");
	std::lock_guard mutationLock(m_staticPublicationMutationMutex);
	br::render::StaticImportBulkPublishResult result;
	if (transactions.empty()) {
		return result;
	}
	RecordStaticGeometryRequirementLocked();
...

	{
		...
		for (auto* transactionPtr : transactions) {
			assert(transactionPtr);
			auto& transaction = *transactionPtr;
			br::render::StaticImportTransactionPublishRecord record;
...
void ObjectManager::CancelStaticImportTransaction(br::render::StaticImportReservation reservation, std::uint64_t retireFrame) {
...
br::render::StaticImportPacket ObjectManager::BuildStaticImportPacket(br::render::StaticImportPacketPlan plan) {
	br::render::StaticImportPacket packet;
	...
	for (size_t groupIndex = 0; groupIndex < plan.prepared.groups.size(); ++groupIndex) {
		...
		if (inserted) {
			br::render::StaticImportPacket::Scope scope;
			scope.id = scopeID;
		...
		br::render::StaticImportPacket::GroupTransformRange range;
	...
	for (size_t groupIndex = 0; groupIndex < plan.prepared.groups.size(); ++groupIndex) {
		...
		for (size_t transformIndex = 0; transformIndex < range.count; ++transformIndex) {
			...
			for (size_t meshTemplateIndex = 0; meshTemplateIndex < meshTemplates.size(); ++meshTemplateIndex) {
				const auto& meshTemplate = meshTemplates[meshTemplateIndex];
				br::render::StaticImportPacket::PatchableDrawRecord record;
...
std::vector<Components::ObjectDrawInfo> ObjectManager::PublishStaticImportPacket(br::render::StaticImportPacket packet) {
	...
	std::unordered_map<DrawWorkloadKey, std::vector<SortedUnsignedIntBuffer::ActiveDrawSetEntry>, DrawWorkloadKey::Hasher> activeDrawSetInserts;
	std::vector<br::render::StaticImportPacket::Scope*> scopeByGroup(drawInfos.size(), nullptr);
	...
	const auto drawRecordUploadBegin = std::chrono::steady_clock::now();
	{
		...
		std::vector<std::vector<const br::render::StaticImportPacket::PatchableDrawRecord*>> drawRecordsByGroup(drawInfos.size());
...
std::vector<Components::ObjectDrawInfo> ObjectManager::CommitPreparedStaticGroupsBulk(const br::render::PreparedStaticGroupsBulkPlan& plan) {
	br::render::StaticImportPacketPlan packetPlan;
	packetPlan.prepared = plan;
	return PublishStaticImportPacket(BuildStaticImportPacket(std::move(packetPlan)));
}

std::vector<Components::ObjectDrawInfo> ObjectManager::AddStaticGroupsBulk(const std::vector<br::render::StaticGroupBuildInfo>& groups) {
	auto plan = PrepareStaticGroupsBulkPlan(groups);
	return CommitPreparedStaticGroupsBulk(plan);
}

br::render::StaticObjectRemovalPayload ObjectManager::BuildStaticObjectRemovalPayload(std::span<const Components::ObjectDrawInfo> drawInfos) const {
	br::render::StaticObjectRemovalPayload payload;
	...
	{
		if (buffer && range.IsValid()) {
			payload.bufferRanges.push_back(br::render::StaticObjectRemovalPayload::BufferRetireRange{ buffer, range, kind });
		}
	};
		...
		br::render::StaticObjectRemovalPayload::BufferKind kind)
	{
		...
		payload.bufferRanges.push_back(br::render::StaticObjectRemovalPayload::BufferRetireRange{
			buffer,
	...
	for (const auto& drawInfo : drawInfos) {
		if (!drawInfo.ownedPerObjectCBPages.empty()) {
			addRanges(m_perObjectBuffers, drawInfo.ownedPerObjectCBPages, br::render::StaticObjectRemovalPayload::BufferKind::PerObject);
		} else if (!drawInfo.perObjectCBViews.empty()) {
			for (const auto& view : drawInfo.perObjectCBViews) {
				addView(m_perObjectBuffers, view, br::render::StaticObjectRemovalPayload::BufferKind::PerObject);
			}
		} else if (drawInfo.perObjectCBView) {
			addView(m_perObjectBuffers, drawInfo.perObjectCBView, br::render::StaticObjectRemovalPayload::BufferKind::PerObject);
		} else {
			addRange(m_perObjectBuffers, drawInfo.perObjectCBRange, br::render::StaticObjectRemovalPayload::BufferKind::PerObject);
		}

		if (!drawInfo.ownedPerInstanceTransformPages.empty()) {
			addRanges(m_perInstanceTransformBuffers, drawInfo.ownedPerInstanceTransformPages, br::render::StaticObjectRemovalPayload::BufferKind::InstanceTransform);
		} else if (!drawInfo.perInstanceTransformViews.empty()) {
			for (const auto& view : drawInfo.perInstanceTransformViews) {
				addView(m_perInstanceTransformBuffers, view, br::render::StaticObjectRemovalPayload::BufferKind::InstanceTransform);
			}
		} else {
			addRange(m_perInstanceTransformBuffers, drawInfo.perInstanceTransformRange, br::render::StaticObjectRemovalPayload::BufferKind::InstanceTransform);
		}

		if (!drawInfo.ownedInstanceDrawRecordPages.empty()) {
			addRanges(m_instanceDrawRecordBuffers, drawInfo.ownedInstanceDrawRecordPages, br::render::StaticObjectRemovalPayload::BufferKind::InstanceDrawRecord);
		} else if (!drawInfo.drawInfo.views.empty()) {
			for (const auto& view : drawInfo.drawInfo.views) {
				addView(m_instanceDrawRecordBuffers, view, br::render::StaticObjectRemovalPayload::BufferKind::InstanceDrawRecord);
			}
		} else {
			addRange(m_instanceDrawRecordBuffers, drawInfo.instanceDrawRecordRange, br::render::StaticObjectRemovalPayload::BufferKind::InstanceDrawRecord);
		}

		if (!drawInfo.ownedNormalMatrixPages.empty()) {
			addRanges(m_normalMatrixBuffer, drawInfo.ownedNormalMatrixPages, br::render::StaticObjectRemovalPayload::BufferKind::NormalMatrix);
		} else if (!drawInfo.normalMatrixViews.empty()) {
			for (const auto& view : drawInfo.normalMatrixViews) {
				addView(m_normalMatrixBuffer, view, br::render::StaticObjectRemovalPayload::BufferKind::NormalMatrix);
			}
		} else if (drawInfo.normalMatrixView) {
			addView(m_normalMatrixBuffer, drawInfo.normalMatrixView, br::render::StaticObjectRemovalPayload::BufferKind::NormalMatrix);
		} else {
			addRange(m_normalMatrixBuffer, drawInfo.normalMatrixRange, br::render::StaticObjectRemovalPayload::BufferKind::NormalMatrix);
		}
	...
	const br::render::RemoveObjectsBulkOptions& options)
{
	...
	std::vector<br::render::StaticObjectRemovalPayload> payloads;
...
br::render::StaticObjectRemovalResult ObjectManager::RemoveStaticObjectsBulk(
		...
		for (const auto& payload : payloads) {
			const auto retirePayloadRange = [&](const auto& retireRange) {
				if (!options.retireInstanceDrawRecordRanges &&
					retireRange.kind == br::render::StaticObjectRemovalPayload::BufferKind::InstanceDrawRecord) {
...
br::render::StaticVisibilityUpdateResult ObjectManager::SetStaticObjectsVisibleBulk(
	std::span<br::render::StaticObjectResidencyHandle*> handles,
	bool visible)
{
	ZoneScopedN("ObjectManager::SetStaticObjectsVisibleBulk");
	std::lock_guard mutationLock(m_staticPublicationMutationMutex);
	br::render::StaticVisibilityUpdateResult spans;
