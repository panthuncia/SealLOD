...
public:
    ...
    static std::shared_ptr<org::Resource> ProvideResource(CLodExtension& extension, org::ResourceIdentifier const& key);
    static std::vector<org::ResourceIdentifier> GetSupportedKeys(const CLodExtension& extension);
