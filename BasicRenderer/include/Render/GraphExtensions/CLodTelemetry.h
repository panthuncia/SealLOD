...
enum class CLodWorkGraphCounterIndex : uint32_t {
    ...
    AssemblyVoxelLeafDepth1,
    AssemblyVoxelLeafDepth2,
    AssemblyVoxelLeafDepth3,
    AssemblyVoxelLeafDepth4Plus,
    AssemblyVoxelRejectedByErrorRecords,
    AssemblyVoxelSuppressedByChildRecords,
    AssemblyVoxelNonResidentRecords,
    AssemblyVoxelNonResidentDepth1,
    AssemblyVoxelNonResidentDepth2,
    AssemblyVoxelNonResidentDepth3,
    AssemblyVoxelNonResidentDepth4Plus,
    AssemblyVoxelRasterWorkRecords,
    AssemblyVoxelRasterWorkDepth1,
    AssemblyVoxelRasterWorkDepth2,
    AssemblyVoxelRasterWorkDepth3,
    AssemblyVoxelRasterWorkDepth4Plus,
