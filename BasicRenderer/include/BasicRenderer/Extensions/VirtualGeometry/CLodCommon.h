...
{
    return !br::extensions::MakeSettingGetter<bool>(CLodReyesGeometricNormalSettingName)();
}

inline float CLodReyesObjectNormalMapBlend()
{
    if (!br::extensions::MakeSettingGetter<bool>(CLodReyesGeometricNormalSettingName)()) {
        return 1.0f;
    }
    return std::clamp(
        br::extensions::MakeSettingGetter<float>(CLodReyesObjectNormalMapBlendSettingName)(),
        0.0f,
        1.0f);
}
...
{
    return std::clamp(
        br::extensions::MakeSettingGetter<float>(CLodReyesTerrainNormalBlendSettingName)(),
        0.0f,
        1.0f);
}
...
{
    return std::min(
        br::extensions::MakeSettingGetter<uint32_t>(CLodReyesTerrainNormalMipBiasSettingName)(),
...
{
    return std::clamp(
        br::extensions::MakeSettingGetter<float>(CLodReyesDiceRatePixelsSettingName)(),
...
inline uint32_t CLodVirtualShadowGetConfiguredMaxBackingResolution()
{
    return CLodVirtualShadowSanitizeBackingResolution(
        br::extensions::MakeSettingGetter<uint32_t>(CLodDirectionalVirtualShadowMaxBackingResolutionSettingName)());
}
...
inline uint32_t CLodVirtualShadowGetConfiguredMaxPhysicalPageCapacity()
{
    ...
    const uint32_t configuredMaxPhysicalPages =
        br::extensions::MakeSettingGetter<uint32_t>(CLodDirectionalVirtualShadowMaxPhysicalPagesSettingName)();
...
inline CLodVirtualShadowResolutionConfig CLodVirtualShadowBuildRuntimeResolutionConfig()
{
    ...
    const float manualDirectionalLodBias =
        br::extensions::MakeSettingGetter<float>(CLodDirectionalVirtualShadowLodBiasSettingName)();
    const bool autoDirectionalLodBias =
        br::extensions::MakeSettingGetter<bool>(CLodDirectionalVirtualShadowAutoLodBiasSettingName)();
    const float autoDirectionalLodBiasScale =
        br::extensions::MakeSettingGetter<float>(CLodDirectionalVirtualShadowAutoLodBiasScaleSettingName)();
