...
// Allocates an identity from the process-wide namespace used by graph
// suspension routing. External producers use this contract without depending
// on the concrete AsyncStateGraph type.
